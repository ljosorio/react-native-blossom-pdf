# react-native-blossom-pdf
[![npm](https://img.shields.io/npm/v/react-native-blossom-pdf.svg?style=flat-square)](https://www.npmjs.com/package/react-native-blossom-pdf)
...
So you should install react-native-blossom-pdf and react-native-blob-util

> The table below shows the supported versions of React Native and react-native-blob-util for different versions of `react-native-blossom-pdf`.

| React Native              | 0.4x - 0.56     | 0.57    | 0.60+    | 0.62+    | 0.62+    |
| ------------------------- | --------------- | ------- | -------- | -------- | -------- |
| react-native-blossom-pdf          | 4.x.x - 5.0.x   | 5.0.9+  | 6.0.0+   | 6.2.0+   | 6.4.0+   |
| react-native-blob-util    |                 |         |          |          | 0.13.7+  |


> 🚨 Expo: This package is not available in the [Expo Go](https://expo.dev/client) app. Learn how you can use this package in [Custom Dev Clients](https://docs.expo.dev/development/getting-started/) via the out-of-tree [Expo Config Plugin](https://github.com/expo/config-plugins/tree/master/packages/react-native-blossom-pdf). Example: [`with-pdf`](https://github.com/expo/examples/tree/master/with-pdf).

### Installation

```bash
# Using npm
npm install react-native-blossom-pdf react-native-blob-util --save

# or using yarn:
yarn add react-native-blossom-pdf react-native-blob-util
```

Then follow the instructions for your platform to link react-native-blossom-pdf into your project:
...
react-native link react-native-blossom-pdf
```
</details>
...
You can add it manually. For detail you can see the issue [`#24`](https://github.com/wonday/react-native-blossom-pdf/issues/24) and [`#2`](https://github.com/wonday/react-native-blossom-pdf/issues/2)

Q2. When running, it shows ```'Pdf' has no propType for native prop RCTPdf.acessibilityLabel of native type 'String'```  
A2. Your react-native version is too old, please upgrade it to 0.47.0+ see also [`#39`](https://github.com/wonday/react-native-blossom-pdf/issues/39)
...
A5. Run the following commands in the project folder (e.g. `react-native-blossom-pdf/example`) to ensure that all dependencies are available:
```
...
[[more]](https://github.com/wonday/react-native-blossom-pdf/releases)
...
import Pdf from 'react-native-blossom-pdf';
